    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                mMap.addMarker(new MarkerOptions().position(new LatLng(Lat, Long)).title("Here!"));
            }
        });
        ...
        LatLng c4q = new LatLng(40.742959, -73.941921);
        mMap.addMarker(new MarkerOptions().position(c4q).title("Marker in C4Q"));
